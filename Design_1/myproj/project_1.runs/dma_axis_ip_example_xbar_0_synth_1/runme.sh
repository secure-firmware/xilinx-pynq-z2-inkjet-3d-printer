...
HD_PWD='C:/Users/w/inkjet_3d/MP113_FPGA/Design_1/myproj/project_1.runs/dma_axis_ip_example_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_axis_ip_example_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_axis_ip_example_xbar_0.tcl
