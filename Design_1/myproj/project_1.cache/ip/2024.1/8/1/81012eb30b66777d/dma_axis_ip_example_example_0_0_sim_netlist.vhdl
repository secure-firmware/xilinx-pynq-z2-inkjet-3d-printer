...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_example_control_s_axi is
  port (
    ...
    ap_clk : in STD_LOGIC;
    grp_example_Pipeline_VITIS_LOOP_31_2_fu_97_ap_start_reg : in STD_LOGIC;
...
STATUS_ap_vld_INST_0: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFAFEAAAAAAAEAAA"
        ...
        port map (
      I0 => \^print_ap_vld\,
      I1 => grp_example_Pipeline_VITIS_LOOP_31_2_fu_97_ap_start_reg,
      I2 => CLK_IN(0),
      I3 => Q(1),
      I4 => Q(2),
...
\CLK_OUT[0]_INST_0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"2A222AAA"
    )
        port map (
...
\ap_CS_fsm[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I0 => Q(0),
      I1 => ap_done_cache,
      I2 => grp_example_Pipeline_VITIS_LOOP_31_2_fu_97_ap_start_reg,
      I3 => CLK_IN(0),
      I4 => Q(1),
      O => D(0)
    );
...
flow_control_loop_pipe_sequential_init_U: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_example_flow_control_loop_pipe_sequential_init_0
     port map (
      ...
      SR(0) => SR(0),
      ap_clk => ap_clk,
      grp_example_Pipeline_VITIS_LOOP_31_2_fu_97_ap_start_reg => grp_example_Pipeline_VITIS_LOOP_31_2_fu_97_ap_start_reg
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_example is
  ...
  signal grp_example_Pipeline_VITIS_LOOP_31_2_fu_97_ap_start_reg : STD_LOGIC;
  signal grp_example_Pipeline_VITIS_LOOP_31_2_fu_97_ap_start_reg_i_1_n_0 : STD_LOGIC;
...
grp_example_Pipeline_VITIS_LOOP_31_2_fu_97: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_example_example_Pipeline_VITIS_LOOP_31_2
     port map (
      CLK_IN(0) => CLK_IN(0),
...
grp_example_Pipeline_VITIS_LOOP_31_2_fu_97_ap_start_reg_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EA"
    )
        port map (
      ...
      I1 => CLK_IN(0),
      I2 => grp_example_Pipeline_VITIS_LOOP_31_2_fu_97_ap_start_reg,
      O => grp_example_Pipeline_VITIS_LOOP_31_2_fu_97_ap_start_reg_i_1_n_0
    );
grp_example_Pipeline_VITIS_LOOP_31_2_fu_97_ap_start_reg_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => ap_clk,
      CE => '1',
      D => grp_example_Pipeline_VITIS_LOOP_31_2_fu_97_ap_start_reg_i_1_n_0,
      Q => grp_example_Pipeline_VITIS_LOOP_31_2_fu_97_ap_start_reg,
      R => ap_rst_n_inv
    );
