...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_example_control_s_axi is
  port (
    ...
    CLK_IN_read_reg_234 : in STD_LOGIC;
...
\STATUS[1]_INST_0_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F4"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_example_flow_control_loop_pipe_sequential_init_0 is
  port (
    ...
    ap_clk : in STD_LOGIC;
    CLK_IN : in STD_LOGIC_VECTOR ( 0 to 0 );
    grp_example_Pipeline_VITIS_LOOP_27_2_fu_162_ap_start_reg : in STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 1 downto 0 )
  );
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_example_regslice_both is
  port (
    ...
    STATUS_ap_vld_0 : in STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_example_regslice_both is
  ...
  signal icmp_ln44_fu_203_p2 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \B_V_data_1_state[0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \B_V_data_1_state[1]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \DATA[0]_INST_0\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \DATA[1]_INST_0\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \DATA[2]_INST_0\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \DATA[3]_INST_0\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \DATA[4]_INST_0\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \DATA[5]_INST_0\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \DATA[6]_INST_0\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \DATA[7]_INST_0\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of DATA_ap_vld_INST_0 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \PRINT[0]_INST_0\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \STATUS[2]_INST_0_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of STATUS_ap_vld_INST_0_i_1 : label is "soft_lutpair9";
...
STATUS_ap_vld_INST_0: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => ap_NS_fsm15_out,
      I2 => STATUS_ap_vld_0(0),
      I3 => \^clk_out_ap_vld\,
      I4 => \^d\(0),
      I5 => Q(1),
      O => STATUS_ap_vld
    );
STATUS_ap_vld_INST_0_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FEEEEEEE"
    )
        port map (
...
STATUS_ap_vld_INST_0_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\tmp_last_reg_238[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8FFB800"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_example is
  ...
  signal A_TVALID_int_regslice : STD_LOGIC;
  signal CLK_IN_read_reg_234 : STD_LOGIC;
  signal \CLK_IN_read_reg_234[0]_i_1_n_0\ : STD_LOGIC;
  ...
  signal grp_example_Pipeline_VITIS_LOOP_27_2_fu_162_ap_start_reg : STD_LOGIC;
  signal grp_example_Pipeline_VITIS_LOOP_27_2_fu_162_ap_start_reg_i_1_n_0 : STD_LOGIC;
  ...
  signal tmp_last_reg_238 : STD_LOGIC;
...
\CLK_IN_read_reg_234[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\CLK_IN_read_reg_234_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => '1',
...
control_s_axi_U: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_example_control_s_axi
     port map (
      ...
      STATUS(2 downto 0) => \^status\(3 downto 1),
...
grp_example_Pipeline_VITIS_LOOP_27_2_fu_162: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_example_example_Pipeline_VITIS_LOOP_27_2
     port map (
      CLK_IN(0) => CLK_IN(0),
...
grp_example_Pipeline_VITIS_LOOP_27_2_fu_162_ap_start_reg_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F4"
    )
        port map (
...
grp_example_Pipeline_VITIS_LOOP_27_2_fu_162_ap_start_reg_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\tmp_last_reg_238_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => '1',
