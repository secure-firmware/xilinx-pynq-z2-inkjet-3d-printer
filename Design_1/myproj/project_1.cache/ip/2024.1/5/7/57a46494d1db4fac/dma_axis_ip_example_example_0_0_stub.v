...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(CLK_OUT_ap_vld, PRINT_ap_vld, DATA_ap_vld, 
  ...
  ap_clk, ap_rst_n, interrupt, A_TVALID, A_TREADY, A_TDATA, A_TDEST, A_TKEEP, A_TSTRB, A_TUSER, 
  A_TLAST, A_TID, ENCODER_IN, CLK_OUT, CLK_IN, PRINT, DATA, STATUS, COUNTER_OUT)
/* synthesis syn_black_box black_box_pad_pin="CLK_OUT_ap_vld,PRINT_ap_vld,DATA_ap_vld,STATUS_ap_vld,COUNTER_OUT_ap_vld,s_axi_control_AWADDR[3:0],s_axi_control_AWVALID,s_axi_control_AWREADY,s_axi_control_WDATA[31:0],s_axi_control_WSTRB[3:0],s_axi_control_WVALID,s_axi_control_WREADY,s_axi_control_BRESP[1:0],s_axi_control_BVALID,s_axi_control_BREADY,s_axi_control_ARADDR[3:0],s_axi_control_ARVALID,s_axi_control_ARREADY,s_axi_control_RDATA[31:0],s_axi_control_RRESP[1:0],s_axi_control_RVALID,s_axi_control_RREADY,ap_rst_n,interrupt,A_TVALID,A_TREADY,A_TDATA[31:0],A_TDEST[5:0],A_TKEEP[3:0],A_TSTRB[3:0],A_TUSER[1:0],A_TLAST[0:0],A_TID[4:0],ENCODER_IN,CLK_OUT,CLK_IN,PRINT,DATA[7:0],STATUS[31:0],COUNTER_OUT[31:0]" */
