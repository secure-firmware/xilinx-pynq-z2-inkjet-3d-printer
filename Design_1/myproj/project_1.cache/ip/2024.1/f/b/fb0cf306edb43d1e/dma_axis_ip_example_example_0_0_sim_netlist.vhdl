...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_example_control_s_axi is
  port (
    ...
    ap_clk : in STD_LOGIC;
    grp_example_Pipeline_VITIS_LOOP_31_2_fu_89_ap_start_reg : in STD_LOGIC;
    CLK_IN : in STD_LOGIC_VECTOR ( 0 to 0 );
    Q : in STD_LOGIC_VECTOR ( 2 downto 0 );
    grp_example_Pipeline_VITIS_LOOP_38_3_fu_99_ap_start_reg : in STD_LOGIC;
...
COUNTER_OUT_ap_vld_INST_0: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
PRINT_ap_vld_INST_0: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => Q(2),
      I3 => CLK_IN(0),
      I4 => grp_example_Pipeline_VITIS_LOOP_38_3_fu_99_ap_start_reg,
      I5 => ap_done_cache,
      O => PRINT_ap_vld
    );
\STATUS[0]_INST_0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"007F7F7F"
    )
        port map (
      I0 => Q(2),
      I1 => grp_example_Pipeline_VITIS_LOOP_38_3_fu_99_ap_start_reg,
      I2 => CLK_IN(0),
      I3 => ap_start,
      I4 => Q(0),
      O => STATUS(0)
    );
\STATUS[1]_INST_0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00808080"
    )
        port map (
...
STATUS_ap_vld_INST_0: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FAFAAEAAAAAAAEAA"
        ...
        port map (
      I0 => \^data_ap_vld\,
      I1 => grp_example_Pipeline_VITIS_LOOP_31_2_fu_89_ap_start_reg,
      I2 => CLK_IN(0),
      I3 => Q(1),
      I4 => Q(2),
      I5 => grp_example_Pipeline_VITIS_LOOP_38_3_fu_99_ap_start_reg,
      O => STATUS_ap_vld
    );
...
\ap_CS_fsm[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => ap_start,
      I2 => ap_done_cache,
      I3 => grp_example_Pipeline_VITIS_LOOP_38_3_fu_99_ap_start_reg,
      I4 => CLK_IN(0),
      I5 => Q(2),
      O => D(1)
    );
...
\ap_CS_fsm[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => grp_example_Pipeline_VITIS_LOOP_38_3_fu_99_ap_start_reg,
      I3 => CLK_IN(0),
      I4 => Q(1),
      O => D(0)
    );
...
\ap_CS_fsm[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I0 => Q(0),
      I1 => ap_done_cache,
      I2 => grp_example_Pipeline_VITIS_LOOP_31_2_fu_89_ap_start_reg,
      I3 => CLK_IN(0),
      I4 => Q(1),
      O => D(0)
    );
...
flow_control_loop_pipe_sequential_init_U: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_example_flow_control_loop_pipe_sequential_init_0
     port map (
      ...
      SR(0) => SR(0),
      ap_clk => ap_clk,
      grp_example_Pipeline_VITIS_LOOP_31_2_fu_89_ap_start_reg => grp_example_Pipeline_VITIS_LOOP_31_2_fu_89_ap_start_reg
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
flow_control_loop_pipe_sequential_init_U: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_example_flow_control_loop_pipe_sequential_init
     port map (
      ...
      grp_example_Pipeline_VITIS_LOOP_38_3_fu_99_ap_start_reg => grp_example_Pipeline_VITIS_LOOP_38_3_fu_99_ap_start_reg
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_example is
  ...
  signal grp_example_Pipeline_VITIS_LOOP_31_2_fu_89_ap_start_reg : STD_LOGIC;
  signal grp_example_Pipeline_VITIS_LOOP_31_2_fu_89_ap_start_reg_i_1_n_0 : STD_LOGIC;
  signal grp_example_Pipeline_VITIS_LOOP_38_3_fu_99_ap_start_reg : STD_LOGIC;
  signal grp_example_Pipeline_VITIS_LOOP_38_3_fu_99_ap_start_reg_i_1_n_0 : STD_LOGIC;
...
begin
  ...
  COUNTER_OUT_ap_vld <= \^data_ap_vld\;
  DATA(7) <= \<const0>\;
  DATA(6) <= \<const0>\;
  DATA(5) <= \<const0>\;
  DATA(4) <= \<const0>\;
...
CLK_OUT_ap_vld_INST_0: unisim.vcomponents.LUT5
    generic map(
      INIT => X"88308800"
        ...
        port map (
      I0 => grp_example_Pipeline_VITIS_LOOP_38_3_fu_99_ap_start_reg,
      I1 => ap_CS_fsm_state5,
      I2 => ap_CS_fsm_state3,
      I3 => CLK_IN(0),
      I4 => grp_example_Pipeline_VITIS_LOOP_31_2_fu_89_ap_start_reg,
      O => CLK_OUT_ap_vld
    );
...
grp_example_Pipeline_VITIS_LOOP_31_2_fu_89: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_example_example_Pipeline_VITIS_LOOP_31_2
     port map (
      CLK_IN(0) => CLK_IN(0),
...
grp_example_Pipeline_VITIS_LOOP_31_2_fu_89_ap_start_reg_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BA"
    )
        port map (
      ...
      I1 => CLK_IN(0),
      I2 => grp_example_Pipeline_VITIS_LOOP_31_2_fu_89_ap_start_reg,
      O => grp_example_Pipeline_VITIS_LOOP_31_2_fu_89_ap_start_reg_i_1_n_0
    );
grp_example_Pipeline_VITIS_LOOP_31_2_fu_89_ap_start_reg_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => ap_clk,
      CE => '1',
      D => grp_example_Pipeline_VITIS_LOOP_31_2_fu_89_ap_start_reg_i_1_n_0,
      Q => grp_example_Pipeline_VITIS_LOOP_31_2_fu_89_ap_start_reg,
      R => ap_rst_n_inv
    );
grp_example_Pipeline_VITIS_LOOP_38_3_fu_99: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_example_example_Pipeline_VITIS_LOOP_38_3
     port map (
      CLK_IN(0) => CLK_IN(0),
      D(0) => ap_NS_fsm(4),
      PRINT(0) => PRINT(0),
...
grp_example_Pipeline_VITIS_LOOP_38_3_fu_99_ap_start_reg_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EA"
    )
        port map (
      ...
      I1 => CLK_IN(0),
      I2 => grp_example_Pipeline_VITIS_LOOP_38_3_fu_99_ap_start_reg,
      O => grp_example_Pipeline_VITIS_LOOP_38_3_fu_99_ap_start_reg_i_1_n_0
    );
grp_example_Pipeline_VITIS_LOOP_38_3_fu_99_ap_start_reg_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => ap_clk,
      CE => '1',
      D => grp_example_Pipeline_VITIS_LOOP_38_3_fu_99_ap_start_reg_i_1_n_0,
      Q => grp_example_Pipeline_VITIS_LOOP_38_3_fu_99_ap_start_reg,
      R => ap_rst_n_inv
    );
end STRUCTURE;
library IEEE;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute X_INTERFACE_PARAMETER of ap_clk : signal is "XIL_INTERFACENAME ap_clk, ASSOCIATED_BUSIF s_axi_control, ASSOCIATED_RESET ap_rst_n, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN dma_axis_ip_example_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
